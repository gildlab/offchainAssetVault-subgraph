...
import {ERC20PriceOracleVault, ERC20PriceOracleVaultConfig} from "./ERC20PriceOracleVault.sol";
...
contract ERC20PriceOracleVaultFactory is Factory {
    ...
    function createChildTyped(ERC20PriceOracleVaultConfig memory config_)
        external
