...
export interface MockChainlinkDataFeedInterface extends utils.Interface {
  functions: {
...
export interface MockChainlinkDataFeed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockChainlinkDataFeedInterface;
