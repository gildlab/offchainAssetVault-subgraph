...
export interface ReceiptVaultFactoryInterface extends utils.Interface {
  functions: {
...
export interface ReceiptVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReceiptVaultFactoryInterface;
